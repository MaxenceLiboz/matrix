...
void run_vector() {
    ...
    std::cout << "v1 - v2: " << std::endl << v1.substract(v2) << std::endl;
    std::cout << "v1 * 2: " << std::endl << v1.scaling(2) << std::endl;
    ...
    std::cout << "v3 - v2: " << std::endl << v3.substract(v2) << std::endl;
    std::cout << "v3 * 2: " << std::endl << v3.scaling(2) << std::endl;
}
...
void run_matrix() {
    ...
    std::cout << "m1 - m2: " << std::endl << m1.substract(m2) << std::endl;
    std::cout << "m1 * 2: " << std::endl << m1.scaling(2) << std::endl;
    ...
    std::cout << "m3 - m2: " << std::endl << m3.substract(m2) << std::endl;
    std::cout << "m3 * 2: " << std::endl << m3.scaling(2) << std::endl;
}
